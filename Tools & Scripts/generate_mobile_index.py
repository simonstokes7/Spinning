  ...
  <div class="screen-container">
    <header>
      <div class="title-group">
        <h1>🚴 Spin 001 - High Energy Endurance <span style="font-size:0.7rem; background:rgba(0,229,255,0.15); color:var(--accent-cyan); padding:2px 8px; border-radius:10px; border:1px solid rgba(0,229,255,0.3); vertical-align:middle; margin-left:8px; font-weight:700;">v3.8.0</span></h1>
      </div>
